...
What's not yet implemented: bookmarks, MCP server, offline audio downloads, multiple reciters, repeat/speed controls, MCP playback control, tafsir UI / reader view, and semantic search (tiers I/II/III). Each lands in its own OpenSpec change against this foundation.
